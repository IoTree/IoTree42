...
class RD200M:
    ...
    def __init__(self, port='/dev/ttyS0', baudrate=19200, period=10):
        """
    ...
    def close(self):
        ...
        if self.__receive_thread and self.__receive_thread.isAlive():            self.__receive_thread.join()
        return True
    ...
    def _process_measurement_data(self, data):
        ...
        self._callback and self._callback({"radon":radon, "status":str(info)})
        return True
